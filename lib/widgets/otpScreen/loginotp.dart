...
import 'package:shapmanpaypoint/controller/Auth/logintimer_controller.dart';
...
class LoginOtpScreen extends StatelessWidget {
  ...
  final LoginTimerController _timerController = Get.put(LoginTimerController());

  final editcontroller = Get.put(SignUpController());
