...
dotenv.config();
function GetUntilityAuth(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(reqbody);
        try {
            const CachedData = cache_1.default.get("AUTH_UTILITY_KEY");
            if (CachedData) {
            ...
            cache_1.default.set("AUTH_UTILITY_KEY", responseData.access_token);
...
setInterval(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield GetUntilityAuth({}, {});
    }
    catch (error) {
        console.error("Error in interval:", error);
    }
}), IntervalsInMilliseconds);
exports.default = GetUntilityAuth;
